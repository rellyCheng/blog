 ...
 * 雪花算法生成long型的id
 *
 * @author Kartist 2018/8/14 15:07
 */
...
//                throw new IllegalStateException("sequence over flow");
        ...
        return String.valueOf((currentStamp - START_STAMP) << timestampBitLeftOffset | idcId << idcBitLeftOffset | machineId << machineBitLeftOffset | sequence);
    }
